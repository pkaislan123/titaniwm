                    ...
                    >
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12} style={{ textAlign: "center" }} >
                            <Typography component="h1" variant="h5" >
                                <span style={{ fontSize: 28, fontWeight: 'bold' }}> Política de Privacidade</span><br></br> <br></br>
                            </Typography>
                        </Grid>
                        ...
                        >
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={8} xl={8} style={{ textAlign: "justify" }} >
                                <Typography component="h1" variant="h5" >
                                    Introdução
                                </Typography>
                                <Typography component="h1" variant="h5" >
                                    ...
                                    <span style={{ fontSize: 14 }}>
                                        ...
                                        Dessa forma, a LD Armazéns, doravante denominada simplesmente como “LD Armazéns Gerais”, inscrita no CNPJ/MF sob o nº 24.986.679/0001-06, no papel de Controladora de Dados, obriga-se ao disposto na presente Política de Privacidade.
                                    </span><br></br> <br></br>
                                </Typography>
                                ...
                                <Typography component="h1" variant="h5" >
                                    <br></br>
                                    <span style={{ fontSize: 14 }}>
                                        Nome com finalidade de identificar quem nós envia formulários de contato
                                        <br></br>
                                        E-mail com finalidade de identificar quem nós envia formulários de contato
                                        <br></br>
                                        Telefone com finalidade de identificar quem nós envia formulários de contato
                                       </span><br></br> <br></br>
                                </Typography>
                                ...
                                <Typography component="h1" variant="h5" >
                                    ...
                                    <span style={{ fontSize: 14 }}>
                                        ...
                                        <br></br>
                                        Nome é coletado ao usuário inserir-lo no campo Nome na página
                                        de contato, no formulário de contato.
                                        
                                        <br></br>
                                        E-mail é coletado ao usuário inserir-lo no campo Nome na página
                                        de contato, no formulário de contato.
                                        <br></br>
                                        Telefone é coletado ao usuário inserir-lo no campo Nome na página
                                        de contato, no formulário de contato.
...
É importante destacar que a revogação do consentimento para o tratamento dos dados pode implicar a impossibilidade da performance adequada de alguma funcionalidade do site que dependa da operação. Tais consequências serão informadas previamente.
                                ...
                                <Typography component="h1" variant="h5" >
                                    <br></br>
                                    <span style={{ fontSize: 14 }}>
                                    A  LD Armazéns assegura a seus usuários/clientes seus direitos de titular previstos no artigo 18 da Lei Geral de Proteção de Dados. Dessa forma, você pode, de maneira gratuita e a qualquer tempo:
...
Solicitar a portabilidade de seus dados, através de um relatório de dados cadastrais que a LD Armazéns trata a seu respeito.
...
Informar-se sobre a possibilidade de não fornecer seu consentimento e sobre as consequências da negativa.
                                ...
                                <Typography component="h1" variant="h5" >
                                    <br></br>
                                    <span style={{ fontSize: 14 }}>
                                    Para exercer seus direitos de titular, você deve entrar em contato com a (nome empresarial simplificado) através dos seguintes meios disponíveis:  <br></br>

(38) 9 9941-6698  <br></br>  <br></br>
De forma a garantir a sua correta identificação como titular dos dados pessoais objeto da solicitação, é possível que solicitemos documentos ou demais comprovações que possam comprovar sua identidade. Nessa hipótese, você será informado previamente.</span><br></br> <br></br>
                                </Typography>
...
Ao concordar com essa Política de Privacidade, você concorda com esse compartilhamento, que se dará conforme as finalidades descritas no presente instrumento.
                                ...
                                <Typography component="h1" variant="h5" >
                                    <br></br>
                                    <span style={{ fontSize: 14 }}>
                                    A LD Armazéns faz uso de Cookies, que são arquivos de texto enviados pela plataforma ao seu computador e que nele se armazenam, que contém informações relacionadas à navegação do site. Em suma, os Cookies são utilizados para aprimorar a experiência de uso.
...
A LD Armazéns utiliza os seguintes Cookies: (id_usuario, usuario).
...
Ao utilizar nossos serviços e fornecer seus dados pessoais após tais modificações, você as consente. 
                                ...
                                <Typography component="h1" variant="h5" >
                                    <br></br>
                                    <span style={{ fontSize: 14 }}>
                                    A LD Armazéns prevê a responsabilidade dos agentes que atuam nos processos de tratamento de dados, em conformidade com os artigos 42 ao 45 da Lei Geral de Proteção de Dados.
...
Caso a Autoridade Nacional de Proteção de Dados exija a adoção de providências em relação ao tratamento de dados realizado pela LD Armazéns, comprometemo-nos a segui-las. 
                                 </span><br></br> <br></br>
                                </Typography>
                                ...
                                <Typography component="h1" variant="h5" >
                                    <br></br>
                                    <span style={{ fontSize: 14 }}>
                                    Conforme mencionado no Tópico 6, embora adotemos elevados padrões de segurança a fim de evitar incidentes, não há nenhuma página virtual inteiramente livre de riscos. Nesse sentido, a LD Armazéns não se responsabiliza por:
...
II – Ações maliciosas de terceiros, como ataques de hackers, exceto se comprovada conduta culposa ou deliberada da LD Armazéns.
...
III – Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários para a utilização dos serviços da LD Armazéns; quaisquer consequências decorrentes de informações falsas ou inseridas de má-fé são de inteiramente responsabilidade do usuário/cliente.</span><br></br> <br></br>
                                </Typography>
                                ...
                                <Typography component="h1" variant="h5" >
                                    ...
                                    A LD Armazéns disponibiliza os seguintes meios para que você possa entrar em contato conosco para exercer seus direitos de titular: (meios de contato).
...
[Aislan Silva Costa (120.927.986-00)]

[comprasaislan@gmail.com]
                                 </span><br></br> <br></br>
